...
public class Domaine implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy=GenerationType.SEQUENCE,generator = "domaine_id_domaine_seq")
    @SequenceGenerator(name = "domaine_id_domaine_seq",sequenceName = "domaine_id_domaine_seq",allocationSize=1) 
